...
| How do I create a MALLEABLE VI (`.vim`)? | `docs/malleable-vis.md` | `scripts/pylv-make-malleable.py` — AIXML alone writes a BROKEN `.vim`, measured with NI's own VIM as control |
