...
internal sealed class TestTools(LvaiConnection connection)
{
    ...
    [McpServerTool(Name = "lvai_generate_test_runner", Destructive = true, OpenWorld = true,
    ...
    public async Task<string> GenerateTestRunnerAsync(
        ...
        await Rpc.GuardAsync(async () =>
        {
            ...
            await File.WriteAllTextAsync(
                aixml, RunnerAixml(runnerViPath, relatives, reportFileName), ct);
    ...
    /// </summary>
    internal static string RunnerAixml(string runnerViPath, IReadOnlyList<string> relativeTestPaths,
                                       string reportFileName)
    {
        var sb = new StringBuilder();
        sb.Append($"<VI _name=\"{Escape(Path.GetFileName(runnerViPath))}\" description=\"")
          .Append("Caraya suite runner\\2C generated by lvai_generate_test_runner.\\0A\\0AIt builds ")
